...
export default function CareerTailwind() {
  return (
    <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-4  gap-y-2 justify-items-center">
          ...
          <figure className="relative">
            <Image
              ...
              height={477}
            />
            <figcaption className="absolute -mt-32 pb-96 left-16 font-medium z-50 text-3xl text-white">
              Grafik
              <span className="block text-md">
                K<span className="text-yellow">[</span>RE
                <span className="text-yellow">]</span>ATYWNIE
              </span>
            </figcaption>
          ...
          <figure className="relative">
            <Image
              ...
              height={477}
            />
            <figcaption className=" absolute -mt-32 left-16 font-medium z-50 text-3xl text-white">
              Copywriter
              <p className="block text-md">
                K<span className="text-yellow">[</span>RE
                <span className="text-yellow">]</span>ACJA
              </p>
            </figcaption>
            <div className="absolute bg-black bg-opacity-70 top-0 w-full h-cardFix z-40"></div>
          </figure>
          <figure className="relative">
            ...
            <figcaption className=" absolute -mt-32 left-16 font-medium z-50 text-3xl text-white">
              ...
              <p className="block text-md">
                K<span className="text-yellow">[</span>RE
                <span className="text-yellow">]</span>ACT.JS
              </p>
            </figcaption>
            <div className="absolute bg-black bg-opacity-70 top-0 w-full h-cardFix z-40"></div>
          </figure>
